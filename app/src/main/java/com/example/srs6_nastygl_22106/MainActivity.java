...
public class MainActivity extends AppCompatActivity {
    ...
    TextView city,temp,condition,veter;
    ImageView icon;
    ...
    public void getData(){
        ...
        String URL = "https://api.weatherapi.com/v1/forecast.json?key=614758894c004537b6051244232810&q="+"Novosibirsk"+"&days=7&aqi=no&alerts=no";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {

                    Log.d("mylog2", "success" );
                    ...
                    for(int i = 0; i< Forecastday.length(); i++)
                    {
                        ...
                        String veter = day.getString("maxwind_mph");
                        wea.add(new Weather(date,maxtemp_c,url, veter));
                    }
